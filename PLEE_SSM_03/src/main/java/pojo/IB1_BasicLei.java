...
public class IB1_BasicLei {
    ...
    public IB1_BasicLei(Integer id, String platform_name, String IB1_VERSION, String diagnose_adr, String IB1_NAME, String IB1_RELEASE_DATE, String IB1_IBN_REQUIRED, String IB1_filename) {
        this.id = id;
