...
public class IB1_REFERENCES_REGULATIONS_REGULATIONLei {
    ...
    public IB1_REFERENCES_REGULATIONS_REGULATIONLei() {
    }

    public IB1_REFERENCES_REGULATIONS_REGULATIONLei(Integer id, String platform_name, String IB1_VERSION, String diagnose_adr, String IB1_NAME, String NAME, String VERSION, String DESC, String FILE_SYSTEM, String URL, String SPARE_PART_NUMBER) {
        this.id = id;
    ...
    public String toString() {
        return "IB1_REFERENCES_REGULATIONS_REGULATIONLei{" +
                "id=" + id +
