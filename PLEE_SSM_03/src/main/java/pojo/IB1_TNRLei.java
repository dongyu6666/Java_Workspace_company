...
public class IB1_TNRLei {
    ...
    public IB1_TNRLei(Integer id, String platform_name, String IB1_VERSION, String diagnose_adr, String IB1_TNR_filename, String PROJECT, String PRODUCT_ID, String VEHICLE, String ODX_PLATFORM, String PART_NUMBER) {
        this.id = id;
