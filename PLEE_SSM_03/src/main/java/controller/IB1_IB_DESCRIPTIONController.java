...
public class IB1_IB_DESCRIPTIONController {
    ...
    public String getIB1_IB_DESCRIPTION(@RequestParam(value="platform_name", required=false) String platform_name, @RequestParam(value="IB1_VERSION", required=false) String IB1_VERSION,@RequestParam(value="diagnose_adr", required=false) String diagnose_adr,Model model){
        ...
        //IB_DESCRIPTION
        IB1_IB_DESCRIPTION_IB_VARIANTSService iB1_IB_DESCRIPTION_IB_VARIANTSService = (IB1_IB_DESCRIPTION_IB_VARIANTSService)context1.getBean("IB1_IB_DESCRIPTION_IB_VARIANTSServiceImpl");
        IB1_IB_DESCRIPTION_OBJECTIVESService iB1_IB_DESCRIPTION_OBJECTIVESService = (IB1_IB_DESCRIPTION_OBJECTIVESService)context2.getBean("IB1_IB_DESCRIPTION_OBJECTIVESServiceImpl");
        IB1_IB_DESCRIPTION_IBNZService iB1_IB_DESCRIPTION_IBNZService = (IB1_IB_DESCRIPTION_IBNZService)context3.getBean("IB1_IB_DESCRIPTION_IBNZServiceImpl");
        IB1_IB_DESCRIPTION_SLAVEService iB1_IB_DESCRIPTION_SLAVEService = (IB1_IB_DESCRIPTION_SLAVEService)context4.getBean("IB1_IB_DESCRIPTION_SLAVEServiceImpl");
