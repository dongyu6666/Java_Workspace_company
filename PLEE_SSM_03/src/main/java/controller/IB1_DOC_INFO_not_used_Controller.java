...
import service.IB1_DOC_INFO_CONTACTSService;
import service.IB1_DOC_INFO_DOC_REVISIONSService;
...
@Controller
public class IB1_DOC_INFO_not_used_Controller {
    //controller调service层
    //@Autowired
    ...
    @RequestMapping("/getIB1_DOC_INFO_not_used")
