...
public class IB1_IB_DESCRIPTION_IBNZLei {
    ...
    public IB1_IB_DESCRIPTION_IBNZLei(Integer id, String platform_name, String IB1_VERSION, String diagnose_adr, String IB1_NAME, String IBNZ_ESTIMATION, String IBNZ_COMMITMENT, String REASON) {
        this.id = id;
