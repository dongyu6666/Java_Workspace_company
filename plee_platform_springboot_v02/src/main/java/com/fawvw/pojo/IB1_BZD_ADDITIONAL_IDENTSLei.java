...
public class IB1_BZD_ADDITIONAL_IDENTSLei {
...
/*
    public IB1_BZD_ADDITIONAL_IDENTSLei() {
    }

    public IB1_BZD_ADDITIONAL_IDENTSLei(Integer id, String platform_name, String IB1_VERSION, String diagnose_adr, String IB1_NAME, String s42_ATTRIBUTES_ADDED, String IDENTS_DESC, String IDENTS_IDENT_NAME, String IDENTS_IDENT_S42_ATTRIBUTE, String IDENTS_IDENT_BGONLINE, String IDENTS_IDENT_DID, String IDENTS_IDENT_COMMENT, String TARGET_DATE) {
        this.id = id;
    ...
    public String toString() {
        return "IB1_BZD_ADDITIONAL_IDENTSLei{" +
                "id=" + id +
