...
public class IB1_ENVIRONMENT_PRODUCTION_MODES_PRODUCTION_MODELei {
    ...
    public IB1_ENVIRONMENT_PRODUCTION_MODES_PRODUCTION_MODELei(Integer id, String platform_name, String IB1_VERSION, String diagnose_adr, String IB1_NAME, String NAME, String DESC, String BYTE_0, String BYTE_1, String BYTE_2) {
        this.id = id;
