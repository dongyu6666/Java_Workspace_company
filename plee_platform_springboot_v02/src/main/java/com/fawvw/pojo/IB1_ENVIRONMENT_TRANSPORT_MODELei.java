...
public class IB1_ENVIRONMENT_TRANSPORT_MODELei {
    ...
    public IB1_ENVIRONMENT_TRANSPORT_MODELei() {
    }

    public IB1_ENVIRONMENT_TRANSPORT_MODELei(Integer id, String platform_name, String IB1_VERSION, String diagnose_adr, String IB1_NAME, String text) {
        this.id = id;
    ...
    public String toString() {
        return "IB1_ENVIRONMENT_TRANSPORT_MODELei{" +
                "id=" + id +
