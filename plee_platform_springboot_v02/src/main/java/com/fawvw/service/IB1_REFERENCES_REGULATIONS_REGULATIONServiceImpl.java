...
@Autowired
    ...
    public int deleteIB1_REFERENCES_REGULATIONS_REGULATION(Map map) {
        return iB1_REFERENCES_REGULATIONS_REGULATIONMapper.deleteIB1_REFERENCES_REGULATIONS_REGULATION(map);
    }
}
