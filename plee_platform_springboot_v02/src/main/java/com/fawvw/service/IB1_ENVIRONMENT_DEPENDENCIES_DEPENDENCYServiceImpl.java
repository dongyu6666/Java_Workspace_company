...
public class IB1_ENVIRONMENT_DEPENDENCIES_DEPENDENCYServiceImpl implements IB1_ENVIRONMENT_DEPENDENCIES_DEPENDENCYService {
    ...
    public int deleteIB1_ENVIRONMENT_DEPENDENCIES_DEPENDENCY(Map map) {
        return iB1_ENVIRONMENT_DEPENDENCIES_DEPENDENCYMapper.deleteIB1_ENVIRONMENT_DEPENDENCIES_DEPENDENCY(map);
    }
}
