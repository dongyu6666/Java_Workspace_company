...
@Autowired
    ...
    public int deleteIB1_ENVIRONMENT_PRE_CONDITIONS_PRE_CONDITION(Map map) {
        return iB1_ENVIRONMENT_PRE_CONDITIONS_PRE_CONDITIONMapper.deleteIB1_ENVIRONMENT_PRE_CONDITIONS_PRE_CONDITION(map);
    }
}
