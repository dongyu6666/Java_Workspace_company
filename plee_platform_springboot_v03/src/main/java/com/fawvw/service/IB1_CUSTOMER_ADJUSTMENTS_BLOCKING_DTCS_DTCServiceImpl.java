...
@Autowired
    ...
    public int deleteIB1_CUSTOMER_ADJUSTMENTS_BLOCKING_DTCS_DTC(Map map) {
        return iB1_CUSTOMER_ADJUSTMENTS_BLOCKING_DTCS_DTCMapper.deleteIB1_CUSTOMER_ADJUSTMENTS_BLOCKING_DTCS_DTC(map);
    }
}
