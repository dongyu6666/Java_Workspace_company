...
@WebServlet("/getIB1_diagnose_adr")
public class getIB1_diagnose_adr_servlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //获得SqlSession对象
            API api = new API();
            api.setStatus("true");
            api.setInfo("offer IB1_diagnose_adr info");
            api.setError("null");

            //声明变量
            SqlSession sqlSession = null;
            IB1_BasicMapper mapper = null;
            List<IB1_BasicLei> IB1_diagnose_adrlist = null;
            String list= null;
            ...
            try {
                ...
                IB1_diagnose_adrlist = mapper.getIB1_diagnose_adr(map);
                //transform IB1_Basic to JSON String


                list = JSON.toJSONString(IB1_diagnose_adrlist);
