...
@WebServlet("/getIB1_IB_DESCRIPTION_OBJECTIVES")
public class getIB1_IB_DESCRIPTION_OBJECTIVES_servlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        IB1_IB_DESCRIPTION_OBJECTIVESMapper mapper = null;
        ...
        try {
            ...
            // getMapper
            mapper = sqlSession.getMapper(IB1_IB_DESCRIPTION_OBJECTIVESMapper.class);
            ...
            IB1_IB_DESCRIPTION_OBJECTIVESlist = mapper.getIB1_IB_DESCRIPTION_OBJECTIVES(map);
            //transform IB1_Basic to JSON String


            list = JSON.toJSONString(IB1_IB_DESCRIPTION_OBJECTIVESlist);
        ...
        String  IB1_IB_DESCRIPTION_OBJECTIVES_JSON = JSON.toJSONString(api);

        // output to Client
        Writer out = response.getWriter();
        out.write(IB1_IB_DESCRIPTION_OBJECTIVES_JSON);
        System.out.println(IB1_IB_DESCRIPTION_OBJECTIVES_JSON);
    }
