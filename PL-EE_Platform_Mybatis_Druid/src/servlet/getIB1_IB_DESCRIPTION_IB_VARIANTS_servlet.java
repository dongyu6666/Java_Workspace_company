...
@WebServlet("/getIB1_IB_DESCRIPTION_IB_VARIANTS")
public class getIB1_IB_DESCRIPTION_IB_VARIANTS_servlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        IB1_IB_DESCRIPTION_IB_VARIANTSMapper mapper = null;
        ...
        try {
            ...
            // getMapper
            mapper = sqlSession.getMapper(IB1_IB_DESCRIPTION_IB_VARIANTSMapper.class);
            ...
            IB1_IB_DESCRIPTION_IB_VARIANTSlist = mapper.getIB1_IB_DESCRIPTION_IB_VARIANTS(map);
            //transform IB1_Basic to JSON String


            list = JSON.toJSONString(IB1_IB_DESCRIPTION_IB_VARIANTSlist);
        ...
        String  IB1_IB_DESCRIPTION_IB_VARIANTS_JSON = JSON.toJSONString(api);

        // output to Client
        Writer out = response.getWriter();
        out.write(IB1_IB_DESCRIPTION_IB_VARIANTS_JSON);
        System.out.println(IB1_IB_DESCRIPTION_IB_VARIANTS_JSON);
    }
