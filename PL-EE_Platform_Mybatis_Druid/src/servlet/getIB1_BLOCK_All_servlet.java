...
@WebServlet("/getIB1_BLOCK_All")
public class getIB1_BLOCK_All_servlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //获得SqlSession对象
            API api = new API();
            api.setStatus("true");
            api.setInfo("offer all IB1 info");
            api.setError("null");
            ...
            try {
                ...
                IB1_PROCEDURES_PROCEDURE_BLOCK_STEPS_STEP_DIAG_PARAMETERSlist = mapper.getIB1_BLOCK_All(map);
