...
@WebServlet("/getIB1_SECURITY_PROPERTIES")
public class getIB1_SECURITY_PROPERTIES_servlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        IB1_SECURITY_PROPERTIESMapper mapper = null;
        ...
        try {
            ...
            // getMapper
            mapper = sqlSession.getMapper(IB1_SECURITY_PROPERTIESMapper.class);
            ...
            IB1_SECURITY_PROPERTIESlist = mapper.getIB1_SECURITY_PROPERTIES(map);
            //transform IB1_Basic to JSON String


            list = JSON.toJSONString(IB1_SECURITY_PROPERTIESlist);
        ...
        String  IB1_SECURITY_PROPERTIES_JSON = JSON.toJSONString(api);

        // output to Client
        Writer out = response.getWriter();
        out.write(IB1_SECURITY_PROPERTIES_JSON);
        System.out.println(IB1_SECURITY_PROPERTIES_JSON);
    }
