...
import dao.IB1_ENVIRONMENT_DEPENDENCIES_DEPENDENCYMapper;
...
@WebServlet("/getIB1_ENVIRONMENT_DEPENDENCIES_DEPENDENCY")
public class getIB1_ENVIRONMENT_DEPENDENCIES_DEPENDENCY_servlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        IB1_ENVIRONMENT_DEPENDENCIES_DEPENDENCYMapper mapper = null;
        ...
        try {
            ...
            // getMapper
            mapper = sqlSession.getMapper(IB1_ENVIRONMENT_DEPENDENCIES_DEPENDENCYMapper.class);
            ...
            IB1_ENVIRONMENT_DEPENDENCIES_DEPENDENCYlist = mapper.getIB1_ENVIRONMENT_DEPENDENCIES_DEPENDENCY(map);
            //transform IB1_Basic to JSON String


            list = JSON.toJSONString(IB1_ENVIRONMENT_DEPENDENCIES_DEPENDENCYlist);
        ...
        String  IB1_ENVIRONMENT_DEPENDENCIES_DEPENDENCY_JSON = JSON.toJSONString(api);

        // output to Client
        Writer out = response.getWriter();
        out.write(IB1_ENVIRONMENT_DEPENDENCIES_DEPENDENCY_JSON);
        System.out.println(IB1_ENVIRONMENT_DEPENDENCIES_DEPENDENCY_JSON);
    }
