...
@WebServlet("/getIB1_IB_DESCRIPTION_IBNZ")
public class getIB1_IB_DESCRIPTION_IBNZ_servlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        IB1_IB_DESCRIPTION_IBNZMapper mapper = null;
        ...
        try {
            ...
            // getMapper
            mapper = sqlSession.getMapper(IB1_IB_DESCRIPTION_IBNZMapper.class);
            ...
            IB1_IB_DESCRIPTION_IBNZlist = mapper.getIB1_IB_DESCRIPTION_IBNZ(map);
            //transform IB1_Basic to JSON String


            list = JSON.toJSONString(IB1_IB_DESCRIPTION_IBNZlist);
        ...
        String  IB1_IB_DESCRIPTION_IBNZ_JSON = JSON.toJSONString(api);

        // output to Client
        Writer out = response.getWriter();
        out.write(IB1_IB_DESCRIPTION_IBNZ_JSON);
        System.out.println(IB1_IB_DESCRIPTION_IBNZ_JSON);
    }
