...
@WebServlet("/getIB1_SECURITY_PROPERTIES_ECU_SECURITY_PROPERTY")
public class getIB1_SECURITY_PROPERTIES_ECU_SECURITY_PROPERTY_servlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        API api = new API();
        api.setStatus("true");
        api.setInfo("offer all IB1_SECURITY_PROPERTIES_ECU_SECURITY_PROPERTY info");
        api.setError("null");
        ...
        try {
            ...
            IB1_SECURITY_PROPERTIES_ECU_SECURITY_PROPERTYlist = mapper.getIB1_SECURITY_PROPERTIES_ECU_SECURITY_PROPERTY(map);
