...
@WebServlet("/getIB1_filename")
public class getIB1_filename_servlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //获得SqlSession对象
            API api = new API();
            api.setStatus("true");
            api.setInfo("offer IB1_filename info");
            api.setError("null");

            //声明变量
            SqlSession sqlSession = null;
            IB1_BasicMapper mapper = null;
            List<IB1_BasicLei> IB1_filenamelist = null;
            String list= null;
            ...
            try {
                ...
                IB1_filenamelist = mapper.getIB1_filename(map);
                //transform IB1_Basic to JSON String


                list = JSON.toJSONString(IB1_filenamelist);
            ...
            String  IB1_filename_JSON = JSON.toJSONString(api);

            // output to Client
            Writer out = response.getWriter();
            out.write(IB1_filename_JSON);
            System.out.println(IB1_filename_JSON);
        }
