...
@WebServlet("/getIB1_DOC_INFO_CONTACTS")
public class getIB1_DOC_INFO_CONTACTS_servlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        //获得SqlSession对象
            ...
            IB1_DOC_INFO_CONTACTSMapper mapper = null;
            ...
            try {
                ...
                // getMapper
                mapper = sqlSession.getMapper(IB1_DOC_INFO_CONTACTSMapper.class);
                ...
                IB1_DOC_INFO_CONTACTSlist = mapper.getIB1_DOC_INFO_CONTACTS(map);
                //transform IB1_Basic to JSON String


                list = JSON.toJSONString(IB1_DOC_INFO_CONTACTSlist);
            ...
            String  IB1_DOC_INFO_CONTACTS_JSON = JSON.toJSONString(api);

            // output to Client
            Writer out = response.getWriter();
            out.write(IB1_DOC_INFO_CONTACTS_JSON);
            System.out.println(IB1_DOC_INFO_CONTACTS_JSON);
        }
