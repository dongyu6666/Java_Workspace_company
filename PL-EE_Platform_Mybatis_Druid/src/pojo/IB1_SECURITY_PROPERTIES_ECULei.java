...
public class IB1_SECURITY_PROPERTIES_ECULei {
    ...
    public IB1_SECURITY_PROPERTIES_ECULei() {
    }

    public IB1_SECURITY_PROPERTIES_ECULei(String platform_name, String IB1_VERSION, String diagnose_adr, String IB1_NAME, String NAME, String ECU_ID) {
    ...
    public String toString() {
        return "IB1_SECURITY_PROPERTIES_ECULei{" +
