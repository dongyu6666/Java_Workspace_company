...
`class` VARCHAR(10) NOT NULL COMMENT '车型级别',
...
`SG_id` INT(11) NOT NULL COMMENT 'SG id',
`create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
`update_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
PRIMARY KEY(`id`)
)ENGINE=INNODB DEFAULT CHARSET=utf8;
INSERT INTO `plee_platform`.`SG` (`id`,`platform_name`,`diagnose_adr`,`SG_name`,`SG_id`) VALUES ('1','MQB','0001','MOT','1'); 
INSERT INTO `plee_platform`.`SG` (`id`,`platform_name`,`diagnose_adr`,`SG_name`,`SG_id`) VALUES ('2','MEB','0019','GWA','2'); 
...
`BLOCK_id` INT(11) NOT NULL COMMENT 'block id',
...
CREATE TABLE `BLOCK`(
`id` INT(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
`BLOCK_NAME` VARCHAR(200) NOT NULL COMMENT 'BLOCK名称',
`BLOCK_id` INT(11) NOT NULL COMMENT 'block id',
...
INSERT INTO `plee_platform`.`BLOCK` (`id`,`BLOCK_NAME`,`BLOCK_id`,`LOGICAL-LINK`,`KD-relevant`,`P-relevant`,`optional`) VALUES 
('1','Verbauprüfung (Master)','1','GatewUDS','1','1','1');
...
INSERT INTO `plee_platform`.`BLOCK_Description` (`id`,`BLOCK_NAME`,`BLOCK_id`,`IB1-DESC`,`IB2P-DESC`,`IB3P-DESC`) VALUES 
('1','Verbauprüfung (Master)','1','IB1_blabla','IB2P_blabla','IB3P_blabla');
...
INSERT INTO `plee_platform`.`BLOCK_TAG` (`id`,`BLOCK_NAME`,`BLOCK_id`,`BLOCK_TAG_Level`,`BLOCK_TAG_TAG`) VALUES 
('1','Verbauprüfung (Master)','1','IB1','IBNZ VSI-Wert aus Gatewa');
...
INSERT INTO `plee_platform`.`BLOCK_IBNZ` (`id`,`BLOCK_NAME`,`BLOCK_id`,`BLOCK_IB1_VSI`,`BLOCK_IB2_VSI`,`BLOCK_IB3_VSI`) VALUES 
('1','Verbauprüfung (Master)','1','0.082','0.08201','0.082');
...
INSERT INTO `plee_platform`.`BLOCK_Variants` (`id`,`BLOCK_NAME`,`BLOCK_id`,`BLOCK_IB1_LAS`,`BLOCK_IB2_LAS`,`BLOCK_IB3_LAS`) VALUES 
('1','Verbauprüfung (Master)','1','1X1','1X2','1X3');
...
`BLOCK_NAME` VARCHAR(200) NOT NULL COMMENT 'BLOCK名称',
`BLOCK_id` INT(11) NOT NULL COMMENT 'block id',
`STEP_NAME` VARCHAR(200) NOT NULL COMMENT 'STEP名称',
`STEP_id` INT(11) NOT NULL COMMENT 'step id',

`STEP_DESC` VARCHAR(1000) COMMENT 'step中的descripition',
...
#=====================================================================================
DROP TABLE IF EXISTS `STEP_TIME-PARAMETER`;

CREATE TABLE `STEP_TIME-PARAMETER`(
`id` INT(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
`STEP_NAME` VARCHAR(200) NOT NULL COMMENT 'STEP名称',
`STEP_id` INT(11) NOT NULL COMMENT 'step id',

`Time_Parameter_DESC` VARCHAR(1000) COMMENT 'step中time parameter的descripition',
`Time_Parameter_Parameter` VARCHAR(100) COMMENT 'step中time parameter的Parameter',
`Time_Parameter_value` VARCHAR(100) COMMENT 'step中time parameter的value',
...
#=====================================================================================
DROP TABLE IF EXISTS `STEP_DIAG-SERVICE`;

CREATE TABLE `STEP_DIAG-SERVICE`(
`id` INT(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
`STEP_NAME` VARCHAR(200) NOT NULL COMMENT 'STEP名称',
`STEP_id` INT(11) NOT NULL COMMENT 'step id',

`SERVICE-IDENTIFIER` VARCHAR(20) COMMENT 'step中Diagnostic_Service的Service_ID',
`LONG-NAME` VARCHAR(500) COMMENT 'step中Diagnostic_Service的name',
`SHORT-NAME` VARCHAR(500) COMMENT 'step中Diagnostic_Service的Service_ID',
...
#=====================================================================================
DROP TABLE IF EXISTS `STEP_DIAG-PARAMETER`;

CREATE TABLE `STEP_DIAG-PARAMETER`(
`id` INT(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
`STEP_NAME` VARCHAR(200) NOT NULL COMMENT 'STEP名称',
`STEP_id` INT(11) NOT NULL COMMENT 'step id',

`LONG-NAME` VARCHAR(100) COMMENT 'step中Diagnostic_Parameter的name',
`SHORT-NAME` VARCHAR(100) COMMENT 'step中Diagnostic_Parameter的shortname',
`MESSAGE-TYPE` VARCHAR(50) COMMENT 'step中Diagnostic_Parameter的Message_Type',
`RESPONSE-SHORT-NAME` VARCHAR(100) COMMENT 'step中Diagnostic_Parameter的Response_Short_Name',
`PATH` VARCHAR(100) COMMENT 'step中Diagnostic_Parameter的Path',
`Unit` VARCHAR(100) COMMENT 'step中Diagnostic_Parameter的Unit',
`DATATYPE` VARCHAR(100) COMMENT 'step中Diagnostic_Parameter的Data_Type',
`VALUE-PROXY` VARCHAR(100) COMMENT 'step中Diagnostic_Parameter的Value',
