...
@Controller
public class IB1_CUSTOMER_ADJUSTMENTS_BLOCKING_DTCS_DTCController {
    //controller调service层
    @Autowired
    ...
    @RequestMapping("/getIB1_CUSTOMER_ADJUSTMENTS_BLOCKING_DTCS_DTC")
    public String getIB1_CUSTOMER_ADJUSTMENTS_BLOCKING_DTCS_DTC(@RequestParam(value="platform_name", required=false) String platform_name, @RequestParam(value="IB1_VERSION", required=false) String IB1_VERSION,@RequestParam(value="diagnose_adr", required=false) String diagnose_adr,Model model){
        API api = new API();
        api.setStatus("true");
