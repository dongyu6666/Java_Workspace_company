...
public class IB1_REFERENCES_RELATED_DOCUMENTS_RELATED_DOCUMENTController {
    ...
    public String getIB1_REFERENCES_RELATED_DOCUMENTS_RELATED_DOCUMENT(@RequestParam(value="platform_name", required=false) String platform_name, @RequestParam(value="IB1_VERSION", required=false) String IB1_VERSION,@RequestParam(value="diagnose_adr", required=false) String diagnose_adr,Model model){
        API api = new API();
        api.setStatus("true");
