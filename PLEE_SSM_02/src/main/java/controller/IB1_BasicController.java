...
import service.IB1_BasicService;
...
public class IB1_BasicController {
    //controller调service层
    @Autowired
    @Qualifier("IB1_BasicServiceImpl")
...
/*================================================================*/
    ...
    public String getIB1_diagnose_adr(@RequestParam(value="platform_name", required=false) String platform_name, @RequestParam(value="IB1_VERSION", required=false) String IB1_VERSION, Model model){
